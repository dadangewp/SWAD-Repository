# -*- coding: utf-8 -*-
"""
Created on Mon Jul  6 17:24:38 2020
...
def RNN(X):
    ...
    layer1 = Embedding(vocab+1, 128, input_length=100, mask_zero=True)(inputs)
    layer2 = Embedding(vocab+1, 16, input_length=100, mask_zero=True)(target)
    #aspect_embed = Flatten()(layer2)
    hidden_text = LSTM(64, return_sequences=True)(layer1)
    hidden_asp_text = LSTM(64, return_sequences=True)(layer2)
    attend_concat = InteractiveAttention()([hidden_text, hidden_asp_text])
    layer = Dense(16,name='FC1')(attend_concat)
